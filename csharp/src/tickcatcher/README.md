...
inputSpec: openapi/tickcatcher.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{4B33BBB7-0456-49D5-8B33-5EF9335FBDB3}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<ICalendarApi>();
            ICalendarApiResponse apiResponse = await api.CalendarAsync("todo");
            List<CalendarEvent>? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Tickcatcher API
- appVersion: 1.1.7
- appDescription: The Tickcatcher API provides access to cryptocurrency market data including candlesticks, symbols, and indicators. All requests require authentication using your RapidAPI key or TickCatcher Direct Key. 
