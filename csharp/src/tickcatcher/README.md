...
additionalProperties:
  packageGuid: '{B5D63403-292B-431D-A9CF-A87797F3DD28}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IBasicIndicatorsApi>();
            IApiIndicatorsEmaPostApiResponse apiResponse = await api.ApiIndicatorsEmaPostAsync("todo");
            List<decimal>? model = apiResponse.Ok();
        }
...
- appVersion: 1.1.0
- appDescription: The Tickcatcher API provides access to cryptocurrency market data including candlesticks, symbols, and indicators. All requests require authentication using your RapidAPI key. 
