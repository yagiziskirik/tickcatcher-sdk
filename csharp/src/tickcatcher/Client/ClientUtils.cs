...
[assembly: InternalsVisibleTo("tickcatcher.Test")]
...
namespace tickcatcher.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string ApiKeyHeaderToString(ApiKeyHeader value)
        {
            return value switch
            {
                ApiKeyHeader.X_RapidAPI_Key => "X-RapidAPI-Key",
                ApiKeyHeader.X_TickCatcher_Key => "X-TickCatcher-Key",
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is Info.PackageNameEnum infoPackageNameEnum)
                return Info.PackageNameEnumToJsonValue(infoPackageNameEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.tickcatcher.com";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.tickcatcher.com";
