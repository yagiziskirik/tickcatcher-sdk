...
class ApiIndicatorsMacdPost200ResponseInner(BaseModel):
    """
    ApiIndicatorsMacdPost200ResponseInner
    """ # noqa: E501
    macd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="MACD")
    signal: Optional[Union[StrictFloat, StrictInt]] = None
    histogram: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["MACD", "signal", "histogram"]
