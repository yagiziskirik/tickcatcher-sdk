...
class ApiIndicatorsBbandsPostRequestParams(BaseModel):
    """
    ApiIndicatorsBbandsPostRequestParams
    """ # noqa: E501
    period: Optional[StrictInt] = 14
    std_dev: Optional[Union[StrictFloat, StrictInt]] = Field(default=2, alias="stdDev")
    __properties: ClassVar[List[str]] = ["period", "stdDev"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stdDev": obj.get("stdDev") if obj.get("stdDev") is not None else 2
        })
        return _obj
