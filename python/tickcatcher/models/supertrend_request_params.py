...
class SupertrendRequestParams(BaseModel):
    """
    SupertrendRequestParams
    """ # noqa: E501
    period: Optional[StrictInt] = 10
    multiplier: Optional[Union[StrictFloat, StrictInt]] = 3
    __properties: ClassVar[List[str]] = ["period", "multiplier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "period": obj.get("period") if obj.get("period") is not None else 10,
            "multiplier": obj.get("multiplier") if obj.get("multiplier") is not None else 3
        })
        return _obj
