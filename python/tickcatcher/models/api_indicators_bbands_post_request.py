...
class ApiIndicatorsBbandsPostRequest(BaseModel):
    """
    ApiIndicatorsBbandsPostRequest
    """ # noqa: E501
    data: CandleData
    params: Optional[ApiIndicatorsBbandsPostRequestParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CandleData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "params": ApiIndicatorsBbandsPostRequestParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
