...
class ZigzagRequestParams(BaseModel):
    """
    ZigzagRequestParams
    """ # noqa: E501
    deviation: Optional[Union[StrictFloat, StrictInt]] = Field(default=1, description="Deviation percentage for ZigZag calculation.")
    __properties: ClassVar[List[str]] = ["deviation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deviation": obj.get("deviation") if obj.get("deviation") is not None else 1
        })
        return _obj
