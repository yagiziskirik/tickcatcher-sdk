...
class Heikenashi200Response(BaseModel):
    """
    Heikenashi200Response
    """ # noqa: E501
    open: Optional[List[Union[StrictFloat, StrictInt]]] = None
    high: Optional[List[Union[StrictFloat, StrictInt]]] = None
    low: Optional[List[Union[StrictFloat, StrictInt]]] = None
    close: Optional[List[Union[StrictFloat, StrictInt]]] = None
    __properties: ClassVar[List[str]] = ["open", "high", "low", "close"]
