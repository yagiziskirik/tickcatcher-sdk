...
class PsarRequest(BaseModel):
    """
    PsarRequest
    """ # noqa: E501
    data: List[Candle]
    params: Optional[PsarRequestParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": PsarRequestParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
