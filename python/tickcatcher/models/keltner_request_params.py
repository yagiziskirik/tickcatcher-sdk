...
class KeltnerRequestParams(BaseModel):
    """
    KeltnerRequestParams
    """ # noqa: E501
    period: Optional[StrictInt] = 20
    multiplier: Optional[Union[StrictFloat, StrictInt]] = 1
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "period": obj.get("period") if obj.get("period") is not None else 20,
