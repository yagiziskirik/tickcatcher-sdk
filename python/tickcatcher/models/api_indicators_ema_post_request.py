...
class ApiIndicatorsEmaPostRequest(BaseModel):
    """
    ApiIndicatorsEmaPostRequest
    """ # noqa: E501
    data: CandleData
    params: Optional[ApiIndicatorsEmaPostRequestParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": ApiIndicatorsEmaPostRequestParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
