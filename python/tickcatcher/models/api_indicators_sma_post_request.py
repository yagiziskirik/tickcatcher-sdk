...
class ApiIndicatorsSmaPostRequest(BaseModel):
    """
    ApiIndicatorsSmaPostRequest
    """ # noqa: E501
    data: CandleData
    params: Optional[ApiIndicatorsSmaPostRequestParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": ApiIndicatorsSmaPostRequestParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
