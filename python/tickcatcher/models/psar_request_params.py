...
class PsarRequestParams(BaseModel):
    """
    PsarRequestParams
    """ # noqa: E501
    step: Optional[Union[StrictFloat, StrictInt]] = 0.02
    max: Optional[Union[StrictFloat, StrictInt]] = 0.2
    __properties: ClassVar[List[str]] = ["step", "max"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "step": obj.get("step") if obj.get("step") is not None else 0.02,
            "max": obj.get("max") if obj.get("max") is not None else 0.2
        })
        return _obj
