...
class ApiIndicatorsMacdPostRequest(BaseModel):
    """
    ApiIndicatorsMacdPostRequest
    """ # noqa: E501
    data: CandleData
    params: Optional[ApiIndicatorsMacdPostRequestParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": ApiIndicatorsMacdPostRequestParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
