...
class Adx200ResponseInner(BaseModel):
    """
    Adx200ResponseInner
    """ # noqa: E501
    adx: Optional[Union[StrictFloat, StrictInt]] = None
    pdi: Optional[Union[StrictFloat, StrictInt]] = None
    mdi: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["adx", "pdi", "mdi"]
