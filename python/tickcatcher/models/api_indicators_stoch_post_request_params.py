...
class ApiIndicatorsStochPostRequestParams(BaseModel):
    """
    ApiIndicatorsStochPostRequestParams
    """ # noqa: E501
    period: Optional[StrictInt] = 14
    signal_period: Optional[StrictInt] = Field(default=3, alias="signalPeriod")
    __properties: ClassVar[List[str]] = ["period", "signalPeriod"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "period": obj.get("period") if obj.get("period") is not None else 14,
            "signalPeriod": obj.get("signalPeriod") if obj.get("signalPeriod") is not None else 3
        })
        return _obj
