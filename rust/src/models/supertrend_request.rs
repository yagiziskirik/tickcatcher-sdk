...
pub struct SupertrendRequest {
    #[serde(rename = "data")]
    pub data: Box<models::CandleData>,
    #[serde(rename = "params", skip_serializing_if = "Option::is_none")]
    pub params: Option<Box<models::SupertrendRequestParams>>,
}

impl SupertrendRequest {
    pub fn new(data: models::CandleData) -> SupertrendRequest {
        SupertrendRequest {
            data: Box::new(data),
            params: None,
        }
