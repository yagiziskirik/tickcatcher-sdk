...
pub struct ApiIndicatorsSmaPostRequest {
    #[serde(rename = "data")]
    pub data: Box<models::CandleData>,
    #[serde(rename = "params", skip_serializing_if = "Option::is_none")]
    pub params: Option<Box<models::ApiIndicatorsSmaPostRequestParams>>,
}

impl ApiIndicatorsSmaPostRequest {
    pub fn new(data: models::CandleData) -> ApiIndicatorsSmaPostRequest {
