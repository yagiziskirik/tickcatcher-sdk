...
pub struct ApiIndicatorsEmaPostRequest {
    #[serde(rename = "data")]
    pub data: Box<models::CandleData>,
    #[serde(rename = "params", skip_serializing_if = "Option::is_none")]
    pub params: Option<Box<models::ApiIndicatorsEmaPostRequestParams>>,
}

impl ApiIndicatorsEmaPostRequest {
    pub fn new(data: models::CandleData) -> ApiIndicatorsEmaPostRequest {
