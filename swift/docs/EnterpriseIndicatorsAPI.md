...
# **keltner**
```swift
    open class func keltner(keltnerRequest: KeltnerRequest, completion: @escaping (_ data: [ApiIndicatorsBbandsPost200ResponseInner]?, _ error: Error?) -> Void)
```
...
let keltnerRequest = keltner_request(data: CandleData(_open: [123], high: [123], low: [123], close: [123], volume: [123]), params: keltner_request_params(period: 123, multiplier: 123)) // KeltnerRequest | 
