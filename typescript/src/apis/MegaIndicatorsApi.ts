...
import {
    ...
    Heikenashi200ResponseFromJSON,
    Heikenashi200ResponseToJSON,
...
export class MegaIndicatorsApi extends runtime.BaseAPI {
     ...
     */
    async heikenashiRaw(requestParameters: HeikenashiOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Heikenashi200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => Heikenashi200ResponseFromJSON(jsonValue));
    }

    /**
     * Calculate Heiken Ashi
     */
    async heikenashi(requestParameters: HeikenashiOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Heikenashi200Response> {
    ...
    async williamsrRaw(requestParameters: WilliamsrRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<number>>> {
        if (requestParameters['apiIndicatorsEmaPostRequest'] == null) {
            throw new runtime.RequiredError(
                'apiIndicatorsEmaPostRequest',
                'Required parameter "apiIndicatorsEmaPostRequest" was null or undefined when calling williamsr().'
            );
        }
